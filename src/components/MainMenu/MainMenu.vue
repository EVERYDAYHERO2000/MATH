<template>
  ...
  <Sidebar 
    ...
    <template v-slot:body>
      <button v-ripple="'rgba(0, 0, 0, 0.02)'" class="main-menu__item" v-on:click="exportToPng">Export as png</button>
      <button v-ripple="'rgba(0, 0, 0, 0.02)'" class="main-menu__item" v-on:click="importExpression">Import Expression</button>
    </template>
